...
const ABOUT: [string, string][] = [
  [
    "왜 개발을 시작했는가",
    "일상생활에서 홈페이지를 만드는 것에 관심을 많이 가지게 되었습니다. 군 제대 후 진로를 두고 한참 방황하다 국비 지원 과정을 알게 되어, 반쯤은 막연한 마음으로 신청했습니다. 그런데 첫 팀 미션에서 클래스 다이어그램을 그리고 로그인 기능을 붙여보면서 <b>“내가 짠 것이 실제로 동작한다”</b>는 감각을 처음 느꼈습니다. 그때부터는 미뤄둔 일이 아니라 하고 싶은 일이 됐습니다.",
  ],
  [
    "어디까지 다루는가",
  ...
  <>
    <header className="hero">
      ...
      <div className="wrap">
        ...
        <div className="route">
          <p className="route-head">개발자로서의 이력</p>
          <ol className="rail">
            {ROUTE.map((s, i) => (
...
const AboutPage: React.FC<{ go: (p: Page) => void }> = ({ go }) => (
  <div style={hueVars(HUE.emerald)}>
    <PageHead
      ...
      lead="꾸준하게 발전하는 개발자로 자기 소개를 적었습니다."
      photo
    >
      ...
      <div className="wrap">
        <Rv className="about">
          <div className="about-text">
            <div className="intro">
              <p className="lead">
                꾸준하게 발전하는 개발자로, <em>소통부터 시작하여 사용자의 편리성을 추구하는 개발자</em>로 성장하고 있습니다.
              </p>
              <hr />
              <p>
                <em>간단한 이력사항</em><br />
                - 2013 ~ 2016 대일고등학교 졸업(서울 강서구) <br />
                - 2017.3 ~ 2024.2 안양대학교 식품영양학과<br />
                - 2024 엑소코바이오 국내영업팀<br />
                - 2024.10~2025.1 한국일본통운 총무부<br />
                <hr />
                <em>교육과정</em><br />
                - 2025.11~2026.05 한국정보교육원<br />
                과정명 : 현업에서 바로 통하는 자바 풀스택 & 생성형 AI 서비스 개발<br />
                <br />
                - 2026.05~2026.11 서울청년취업사관학교(Sesac) <br />
                과정명 : AWS와 AI를 활용한 MSA 기반 웹 서비스 개발
              </p>
              <hr />
              <p>
...
const HistoryPage: React.FC<{ go: (p: Page) => void }> = ({ go }) => (
  <div style={hueVars(HUE.amber)}>
    <PageHead
      ...
      lead="고등학교 때부터 지금 이순간까지의 제가 달려온 이력을 정리를 하였습니다."
    />
    <section>
      <div className="wrap">
